 ...
 bgc.alpha_ammox_n2o = bgc.eps_ammox_no2./1000.0+1.0;  % Fractionation factor during N2O prod. via NH2OH (permil)
 ...
 % Alpha for den3 -- N2O-->N2
 bgc.alpha_den3 = bgc.eps_den3./1000.0+1.0;          % Fractionation factor during denitrification 3 (permil)
