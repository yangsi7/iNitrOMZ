...
if ~isnan(A.SP) .* ~isnan(A.i15N(1)) .* ~isnan(A.N(1))
	...
	iso.i15N_A = 0.5.*(A.SP./1000.0.*Nstd1.*iso.i14N + A.i15N);
	iso.i15N_B = A.i15N - iso.i15N_A;
	iso.i14N_A = iso.i15N_A;
	iso.i14N_B = iso.i15N_B;
	iso.i14N_J = iso.i14N - (iso.i14N_A+iso.i14N_B);
